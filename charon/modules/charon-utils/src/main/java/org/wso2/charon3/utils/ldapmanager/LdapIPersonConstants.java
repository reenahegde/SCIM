...
public class LdapIPersonConstants {
	...
	//XXXXXX public static final String x121Address = "x121Address";
	...
	public static final String organizationalUnitName = "organizationalUnitName";
	public static final String Timezone = "Timezone";
	public static final String instantMessagingID = "instantMessagingID";
